...
export function getOtherSpotCheckList(data) {
	return request({
		url: '/equipment/equipCheck/othercheck',
		method: 'get',
		data
	})
}
export function getProSpotCheckList(data) {
	return request({
		url: '/equipment/equipCheck/proCheck',
		method: 'get',
		data
	})
}
...
export function getSpotCheckItems(data) {
	return request({
		url: '/equipment/equipCheck/opInit',
		method: 'get',
		data
	})
}
...
export function spotCheckSubmit(data) {
	return request({
		url: '/equipment/equipCheck/checkSubmit',
		method: 'post',
		data
	})
}
...
export function keepCheckRec(data) {
	return request({
		url: '/equipment/equipCheck/keepCheckRec',
		method: 'post',
		data
	})
}