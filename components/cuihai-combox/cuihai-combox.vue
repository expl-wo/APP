<template>
	<view class="uni-combox">
		...
		<view class="uni-combox__input-box">
			...
			<!-- <icon type="clear" size="5" @tap="clearInputValue" v-if="!isDisabled" /> -->
			<image class="uni-combox__input-arrow" src="../../static/arrow_down.png" style="width: 30rpx;height: 30rpx;" @click="toggleSelector"></image>
